                ...
                <div class="aqua-container">
                    ...
                    <div class="aqua-well-mini pull-right">
                        <div class="aqua-user">
                            ...
                            <span class="aqua-user-name"><?php echo $this->requestAction("/Alumnos/datos_alumno")["Alumno"]["nombreCompleto"]; ?></span>
            ...
            <div  id="aqua-menu" data-offset-top="80" data-spy="affix" class="subnav navbar affix">
                ...
                <div class="aqua-container">
                    ...
                    <ul class="nav">
                        ...
                        <li>
                            <a href="<?php echo $this->Html->url(array("controller" => "Cursos", "action" => "cursosByAlumno")) ?>">
                                <span class="modernpics icons16 icons-white">a</span>
                                Cursos
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo $this->Html->url(array("controller" => "Notas", "action" => "index_alumno")) ?>">
