<!-- File: /app/View/Pagos/cancelar.ctp -->
<!DOCTYPE html>
<html lang="es">
    <head>
        <meta charset="utf-8">
        ...
        <div class="aqua-container">
            <div class="span3 offset2">
                <div class="aqua-panel">
                    <h4>Esta acción requiere la aprobación de un Usuario Administrador</h4>
                    ...
                    <div class="aqua-panel-content">
                        ...
                        <?php echo $this->Form->create("Pagos"); ?>
                            ...
                            <hr/>
                            <button class="pull-right btn btn-primary btn-large btn-block" type="submit" name="yt0">Aceptar</button>
                            <div class="clear"></div>
