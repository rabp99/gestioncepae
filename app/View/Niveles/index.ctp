...
<table class="items table table-striped table-bordered table-condensed">
    <thead>
        <tr>
            <th id="user-grid_c0"><?php echo $this->Paginator->sort("idnivel", "Código <span class='caret'></span>", array("escape" => false)); ?></th>
    ...
    <?php foreach ($niveles as $nivel) {
        echo $this->Html->tableCells(
            array(
                ...
                $this->Form->postLink("<i class='icon-trash'></i>", array("action" => "delete", $nivel["Nivel"]["idnivel"]), array("confirm" => "¿Estás seguro?", "escape" => false, "title" => "Deshabilitar"))
            ), array(
                "class" => "odd"
            ), array(
                "class" => "even"
