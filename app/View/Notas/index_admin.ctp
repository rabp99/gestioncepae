<!-- File: /app/View/Notas/index_admin.ctp -->
<?php 
    ...
    <?php foreach ($matriculas as $matricula) {
        echo $this->Html->tableCells(
            array(
                ...
                $this->Html->link("<i class='icon-eye-open'></i>", array("action" => "view_admin", $matricula["Matricula"]["idmatricula"]), array("escape" => false, "title" => "Detalle", "rel" => "tooltip")) . " " .
                $this->Html->link("<i class='icon-pencil'></i>", array("action" => "registrar_admin", $matricula["Matricula"]["idmatricula"]), array("escape" => false, "title" => "Registrar", "rel" => "tooltip"))
            ), array(
                "class" => "odd"
            ), array(
                "class" => "even"
