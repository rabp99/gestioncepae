<!-- File: /app/View/Cursos/view_apoderado.ctp -->
<?php 
    $this->extend("/Common/view");
    $this->assign("titulo", "Detalle de Curso");
    $this->assign("id", $curso["Curso"]["idcurso"]);    
    
    $this->Html->addCrumb('Cursos', '/Cursos/cursosByApoderado');
...
<?php echo $this->Html->link("Regresar", array("action" => "cursosByApoderado")); ?>